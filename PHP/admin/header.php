<header style="box-shadow: 0px 10px 15px 0px rgba(0,0,0,0.10);" class="bg-dark">
    <div class="container d-flex justify-content-between">
        <div class="logo d-flex align-items-center">
            <a href="../public/view/campanha"><img style="width: 120px;" class="logoPrincipal" src="./assets/logo.png" alt=""></a>
            <h3 style="margin-bottom: 0 !important;" class="text-white textPainel">Painel de Administração</h3>
        </div>
        <nav class="navbar">
            <div class="d-flex">
                ...
                <ul style="margin-bottom: 0; padding-left: 20px; align-items: center;" class="list-unstyled d-flex justify-content-center align-items-center bg-primary p-2 rounded">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle buttonSair" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" width="25" viewBox="0 0 24 24">
                    ...
                    <div style="font-size: 15px; padding-top: 3px;" class="text-white px-2 d-none d-md-flex">Bem vindo, <?= $_SESSION["usuario"]["login"] ?></div>
                </ul>
